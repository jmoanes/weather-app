    ...
    <header class="header">
      ...
      <div class="header-searchbar">
        <div class="search-input-wrapper" style="width: 100%; max-width: 1000px; margin: 0 auto; position: relative;">
          ...
          <input type="text" class="search-input-rounded" placeholder="Search for a city or country..." id="city-search" autocomplete="off" spellcheck="false" maxlength="100" style="position: relative; z-index: 1; background: transparent; color: black; border: none; padding: 14px 20px 14px 44px; width: 100%; box-sizing: border-box; font-size: 16px; border-radius: 20px; outline: none;">
          <button class="search-btn-inside" id="search-btn" style="background: #1976d2; color: white; border: none; border-radius: 22px; height: 45px; width: auto; min-width: 96px; padding: 0 16px; display: flex; align-items: center; justify-content: center; cursor: pointer; margin-right: 8px; box-shadow: none; transition: none; z-index: 6;">
